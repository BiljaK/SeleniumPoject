...
public class DressesPage {
	...
	public void clickAdd1Dress() throws InterruptedException {
		...
		Thread.sleep(3000);
		WebElement clickAdd= driver.findElement(By.xpath("/html/body/div/div[2]/div/div[3]/div[2]/ul/li[1]/div/div[2]/div[2]/a[1]"));
		clickAdd.click();
		
	//	act.moveToElement(clickAdd).click().perform();
	...
	public void clickAdd2ndDress() throws InterruptedException {
		...
		Thread.sleep(3000);
		WebElement clickAdd= driver.findElement(By.xpath("/html/body/div/div[2]/div/div[3]/div[2]/ul/li[2]/div/div[2]/div[2]/a[1]"));
		clickAdd.click();
	...
	public void clickAdd3rdDress() throws InterruptedException {
		...
		Thread.sleep(3000);
		WebElement clickAdd= driver.findElement(By.xpath("/html/body/div/div[2]/div/div[3]/div[2]/ul/li[3]/div/div[2]/div[2]/a[1]"));
		clickAdd.click();
		//act.moveToElement(clickAdd).click().perform();
